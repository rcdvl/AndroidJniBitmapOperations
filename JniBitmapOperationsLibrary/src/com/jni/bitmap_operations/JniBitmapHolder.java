...
public class JniBitmapHolder {
    ...
    private native ByteBuffer jniStoreBitmapDataFromPath(String bitmapPath);
    ...
    public JniBitmapHolder(final String bitmapPath) {
        storeBitmap(bitmapPath);
    }

    private void storeBitmap(String bitmapPath) {
        if (_handler != null)
            freeBitmap();
        _handler = jniStoreBitmapDataFromPath(bitmapPath);
    }
